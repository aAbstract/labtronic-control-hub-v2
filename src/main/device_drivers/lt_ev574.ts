...
ipcMain.handle(`${DEVICE_MODEL}_get_device_config`, () => LT_EV574_DRIVER_CONFIG);
...
const LT_EV574_DEVICE_CMD_HELP: string[] = [
    '=======================================================================================================',
    `SET CONTROL_BUTTONS <value>, Alias: SCB <value> | Control Device Control_BUTTONS, 0 <= value <= ${MAX_CONTROL_BUTTONS}`,
    '=======================================================================================================',
];
