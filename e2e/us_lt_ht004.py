...
def us_change_sample_shape(driver: webdriver.Chrome) -> int:
    ...
    drop_down_button = driver.find_element(By.CSS_SELECTOR, '#pv_id_11>:last-child')
    options_id = ['#pv_id_11_0', '#pv_id_11_1', '#pv_id_11_2']
...
def us_record_reset_plate_mode(driver: webdriver.Chrome) -> int:
    ...
    drop_down_button = driver.find_element(By.CSS_SELECTOR, '#pv_id_11>:last-child')
    drop_down_button.click()
    plate_mode =driver.find_element(By.CSS_SELECTOR, '#pv_id_11_0')
    plate_mode.click()
...
def us_compute_ts(driver: webdriver.Chrome) -> int:
    ...
    drop_down_button = driver.find_element(By.CSS_SELECTOR, '#pv_id_11>:last-child')
    options_id = ['#pv_id_11_1','#pv_id_11_2']
    reset_button.click()
    # for the two modes
