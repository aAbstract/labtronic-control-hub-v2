...
lt_ht107_vspi = VSPI(device_model='LT-HT107', device_driver=ltd_driver_lt_ht107,)
...
lt_to202_vspi = VSPI(device_model='LT-TO202', device_driver=ltd_driver_lt_to202,auto_connect=True)
...
lt_ee759_vspi = VSPI(device_model='LT-EE759', device_driver=ltd_driver_lt_ee759)
