...
lt_ch000_vspi = VSPI(device_model='LT-CH000', device_driver=ltd_driver_lt_ch000, auto_connect=True)
lt_ht004_vspi = VSPI(device_model='LT-HT004', device_driver=ltd_driver_lt_ht004)
lt_ht103_vspi = VSPI(device_model='LT-HT103', device_driver=ltd_driver_lt_ht103, control_feedback_map={12: 5, 13: 6}, auto_connect=False)
